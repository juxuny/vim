...
FROM registry.cn-shenzhen.aliyuncs.com/juxuny-public/builder:gcc-11.3.0 AS gcc-11.3.0

FROM registry.cn-shenzhen.aliyuncs.com/juxuny-public/builder:gcc-12.2.0 AS gcc-12.2.0

FROM registry.cn-shenzhen.aliyuncs.com/juxuny-public/vim:base-v1.2.0 as final
USER root
WORKDIR /work
