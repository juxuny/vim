...
RUN apt-get update && apt-get install -y tzdata git ruby-full gem ruby-dev curl python ack-grep build-essential cmake python3-dev openjdk-11-jdk software-properties-common python3-pip
